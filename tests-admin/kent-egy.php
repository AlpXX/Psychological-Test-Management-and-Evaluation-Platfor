...
<body>
	...
	<form style="padding-bottom: 300px" action="../evaluation/kent-egy-evaluation.php" method="POST">
		<div class="container">
		  ...
		  <div class="options">
		  				<input class='answers' type="text" name="cevap1-1" readonly> 
		...
		<div class="container">
		  ...
		  <div class="options">
		  				<input class='answers' type="text" name="cevap2-1"readonly>	    
		  </div>
		</div>
		...
		<div class="container">
		  ...
		  <div class="options">
					    <input class='answers' type="text" name="cevap3-1" readonly> 	
		  </div>
		</div>
		...
		<div class="container">
		  ...
		  <div class="options">
		    			<input class='answers' type="text" name="cevap4-1"readonly>
		  </div>
		</div>
		...
		<div class="container">
		  ...
		  <div class="options">	
		 			    <input class='answers' type="text" name="cevap5-1" readonly> 		    
		  </div>
		</div>
		...
		<div class="container">
		  ...
		  <div class="options">
		    <input class='answers' type="text" name="cevap6-1" readonly>
		  </div>
		  </div>
		  ...
		  <div class="options">
		  		<input class='answers' type="text" name="cevap7-1" readonly>
		...
		<div class="container">
		  ...
		  <div class="options">
		    			<input class='answers' type="text" name="cevap8-1" readonly>	
		  </div>
		  ...
		  <div class="options">
		   				 <input class='answers' type="text" name="cevap9-1" readonly> 
		  </div>
		  ...
		  <div class="question">
			...
			Your answer:<br><br> 		    		   		    		   
		  <div class="options">
		    			<input class='answers' type="number" name="cevap10-1" readonly> 
		  </div>
		  <br><br>
